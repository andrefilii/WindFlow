...
#include <persistent/p_window_replica_TB_NINC.hpp>
...
namespace wf
{
    ...
    private:
        ...
        void appendStats(rapidjson::PrettyWriter<rapidjson::StringBuffer> &writer) const override
        {
            ...
            writer.StartArray();
            for (auto *r : replicas)
            { // append the statistics from all the replicas of the P_Keyed_Windows
    ...
    public:
        ...
        P_Keyed_Windows(win_func_t _func,
                        ...
                        uint64_t _lateness,
                        Win_Type_t _winType,
                        bool _sort_enabled) : Basic_Operator(_parallelism, _name, Routing_Mode_t::KEYBY, _outputBatchSize),
                                              func(_func),
                                              key_extr(_key_extr),
                                              win_len(_win_len),
        ...
        /// Copy constructor
        P_Keyed_Windows(const P_Keyed_Windows &_other) : Basic_Operator(_other),
                                                         func(_other.func),
