...
fig.align_labels()
fig.suptitle(f"IWS COUNT-BASED 500K KEYS STATE RESIDENT MEMORY USAGE (RSS)")
fig.supxlabel("Time (seconds)")
fig.supylabel("MB Resident Memory")

_data = np.loadtxt(
    f"{KEYS}/memory/0_{KEYS}000_1_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}/1mem/0_{KEYS}000_1_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}/2mem/0_{KEYS}000_1_mem.txt.dat", dtype="uint64")
...
_data = np.loadtxt(
    f"{KEYS}/memory/0_{KEYS}000_2_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}/1mem/0_{KEYS}000_2_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}/2mem/0_{KEYS}000_2_mem.txt.dat", dtype="uint64")
_data = [(i/1024) for i in _data]
__data = [(i/1024) for i in __data]
___data = [(i/1024) for i in ___data]
_dataf = list(filter(lambda x: x > 0, _data))
...
_data = np.loadtxt(
    f"{KEYS}/memory/0_{KEYS}000_3_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}/1mem/0_{KEYS}000_3_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}/2mem/0_{KEYS}000_3_mem.txt.dat", dtype="uint64")
_data = [(i/1024) for i in _data]
__data = [(i/1024) for i in __data]
___data = [(i/1024) for i in ___data]
_dataf = list(filter(lambda x: x > 0, _data))
...
_data = np.loadtxt(
    f"{KEYS}/memory/0_{KEYS}000_5_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}/1mem/0_{KEYS}000_5_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}/2mem/0_{KEYS}000_5_mem.txt.dat", dtype="uint64")
_data = [(i/1024) for i in _data]
__data = [(i/1024) for i in __data]
___data = [(i/1024) for i in ___data]
_dataf = list(filter(lambda x: x > 0, _data))
