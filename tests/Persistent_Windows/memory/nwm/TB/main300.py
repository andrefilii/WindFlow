...
fig.align_labels()
fig.suptitle(f"NWM TIME-BASED 300K KEYS STATE RESIDENT MEMORY USAGE (RSS)", ha = "center")
fig.supxlabel("Time (seconds)")
fig.supylabel("MB Resident Memory")

_data = np.loadtxt(
    f"{KEYS}k/memory/1_{KEYS}000_1_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}k/frag32(2)/0_{KEYS}000_1_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}k/frag64(2)/0_{KEYS}000_1_mem_64.txt.dat", dtype="uint64")
...
_data = np.loadtxt(
    f"{KEYS}k/memory/1_{KEYS}000_2_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}k/frag32(2)/0_{KEYS}000_2_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}k/frag64(2)/0_{KEYS}000_2_mem_64.txt.dat", dtype="uint64")
_data = [(i/1024) for i in _data]
__data = [(i/1024) for i in __data]
___data = [(i/1024) for i in ___data]
_dataf = list(filter(lambda x: x > 0, _data))
...
_data = np.loadtxt(
    f"{KEYS}k/memory/1_{KEYS}000_3_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}k/frag32(2)/0_{KEYS}000_3_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}k/frag64(2)/0_{KEYS}000_3_mem_64.txt.dat", dtype="uint64")
_data = [(i/1024) for i in _data]
__data = [(i/1024) for i in __data]
___data = [(i/1024) for i in ___data]
_dataf = list(filter(lambda x: x > 0, _data))
...
_data = np.loadtxt(
    f"{KEYS}k/memory/1_{KEYS}000_5_mem.txt.dat", dtype="uint64")
__data = np.loadtxt(
    f"{KEYS}k/frag32(2)/0_{KEYS}000_5_mem.txt.dat", dtype="uint64")
___data = np.loadtxt(
    f"{KEYS}k/frag64(2)/0_{KEYS}000_5_mem_64.txt.dat", dtype="uint64")
_data = [(i/1024) for i in _data]
__data = [(i/1024) for i in __data]
___data = [(i/1024) for i in ___data]
_dataf = list(filter(lambda x: x > 0, _data))
