...
fig.align_labels()
fig.suptitle(f"INCREMENTAL WINDOW SUM (IWS) TIME BASED THROUGHPUT MEMORYCAP 8GB\nLOG SCALE", ha = "center")
fig.supxlabel("KEYS")
...
#normal1716 = [0]
normalt3432 = [16887,16651,16860,17293,16999]
#normalt3432 = [0]
...
#normal1716 = [0]
normalt3432 = [64155,58372,62416,65901,63424]
fnormal = [np.mean(normal1716),np.mean(normalt3432)]
fnormalerr = [np.std(normal1716),np.std(normalt3432)]
...
#normal1716 = [0]
normalt3432 = [115005,103477,103239,120413,116828]
fnormal = [np.mean(normal1716),np.mean(normalt3432)]
fnormalerr = [np.std(normal1716),np.std(normalt3432)]
...
#normal1716 = [0]
normalt3432 = [222789,189526,212591,209481,219480]
fnormal = [np.mean(normal1716),np.mean(normalt3432)]
fnormalerr = [np.std(normal1716),np.std(normalt3432)]
