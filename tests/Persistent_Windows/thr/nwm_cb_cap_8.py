...
#PARALLELISM 1
normal1716 = [70812,83241,85940,75842,78329]
#normalt3432 = [49814,48482,46723,47390,50133]
...
#PARALLELISM 2
normal1716 = [100381,101567,102481,105841,103818]
#normalt3432 = [97041,98361,97341,100641,97381]
normalt3432 = [0,0,0,0,0]
fnormal = [np.mean(normal1716),np.mean(normalt3432)]
fnormalerr = [np.std(normal1716),np.std(normalt3432)]
...
#PARALLELISM 3 
normal1716 = [136093,140831,135311,138927,141294]
#normalt3432 = [135631,149133,136670,147317,146361]
normalt3432 = [0,0,0,0,0]
fnormal = [np.mean(normal1716),np.mean(normalt3432)]
fnormalerr = [np.std(normal1716),np.std(normalt3432)]
...
#PARALLELISM 5
normal1716 = [175545,188357,200985,190823,187418]
#normalt3432 = [254178,241009,230913,245791,231423]
normalt3432 = [0,0,0,0,0]
fnormal = [np.mean(normal1716),np.mean(normalt3432)]
fnormalerr = [np.std(normal1716),np.std(normalt3432)]
